    ...
    <div class="container">
      ...
      <div class="card2">
        <nav aria-label="Pages">
          <ul class="pagination">
            <li class="page-item">
              <a class="page-link" @click="$router.back()" aria-label="Previous">
  ...
  methods: {
    getAllMovies2() {
      this.$axios
        ...
        .then(response => {
          this.contents2 = response.data.results;
          this.getAllGenres();
    ...
    filteredList() {
      if (this.searchTitle == "") {
        this.contents2 = this.contents2.filter(contents2 => {
          return contents2.genre_ids
            .toString()
            .toLowerCase()
        ...
        this.contents2 = this.contents2.filter(contents2 => {
          return contents2.original_title
            .toLowerCase()
